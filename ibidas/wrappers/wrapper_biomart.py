...
class BiomartConnection(object):
    ...
    def __repr__(self):
        ...
        tablenames = list(self.tabledict.keys())
        tablenames.sort()
...
class BiomartRepresentor(wrapper.SourceRepresentor):
    ...
    def __init__(self, url, query):
        ...
        self._encoded_query = url + "?" + urllib.parse.urlencode([('query', str(querydom.toxml()))])
    ...
    def pyexec(self, executor):
        req = urllib.request.urlopen(self._encoded_query)
