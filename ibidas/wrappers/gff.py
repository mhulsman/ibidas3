...
def split_entry(raw):
    ...
    entry           = dict( list(zip(entry_field_names, fields )) );
...
def to_row(record):
    ...
    for pos, exon_pos in enumerate(exons):
        ...
        n = list(zip(start[exon_pos], stop[exon_pos]))
    ...
    for pos, mrna_pos in enumerate(mrnas):
        ...
        locpairs = list(zip(start[mrna_pos], stop[mrna_pos]))
    ...
    #write exon records
    exon_list = list(exon_dict.items())
    ...
    for cds_pos in cdss:
        ...
        locpairs = list(zip(start[cds_pos], stop[cds_pos]))
    ...
    for pos, other_pos in enumerate(others):
        ...
        n = list(zip(start[other_pos], stop[other_pos]))
